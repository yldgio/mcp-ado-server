...
class VariableGroupService:
    ...
    async def list_variable_groups(
        ...
        try:
            ...
            return MCPToolResult.error("Failed to list variable groups", str(e))

    async def get_variable_group_details(self, project: str, group_id: int) -> MCPToolResult:
        ...
        try:
            ...
            return MCPToolResult.success(result, f"Variable group '{vg.name}' details")

        except Exception as e:
            logger.error(f"Error getting variable group details: {e}")
            return MCPToolResult.error("Failed to get variable group details", str(e))
...
class ServiceConnectionService:
    ...
    async def list_service_connections(
        ...
        try:
            ...
            return MCPToolResult.error("Failed to list service connections", str(e))
    ...
    async def get_service_connection_details(
        ...
        try:
            ...
            return MCPToolResult.success(result, f"Service connection '{sc.name}' details")

        except Exception as e:
            logger.error(f"Error getting service connection details: {e}")
            return MCPToolResult.error("Failed to get service connection details", str(e))
