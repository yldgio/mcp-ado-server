...
class AzureDevOpsClient:
    ...
    async def get_variable_groups(
        ...
        url = f"{self.config.api_url}/distributedtask/variablegroups"
    ...
    async def get_variable_group(self, project: str, group_id: int) -> Optional[VariableGroup]:
        ...
        url = f"{self.config.api_url}/distributedtask/variablegroups/{group_id}"
        
        try:
            response = await self._make_request("GET", url, params={"projectId": project})
    ...
    async def get_service_connections(
        ...
        url = f"{self.config.api_url}/serviceendpoint/endpoints"
    ...
    async def get_service_connection(self, project: str, connection_id: str) -> Optional[ServiceConnection]:
        """Get a specific service connection by ID."""
        url = f"{self.config.api_url}/serviceendpoint/endpoints/{connection_id}"
